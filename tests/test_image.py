...
#if upload fails, then IAM credentials are wrong, or the bucket name is wrong, or the region is wrong. 
#If upload works but delete fails, then the IAM credentials are wrong (delete permissions are missing).
